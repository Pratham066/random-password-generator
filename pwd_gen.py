...
def gen_pwd():
    ...
    LIMIT = random.randrange(MAX_LEN-MIN_LEN)+MIN_LEN
    ...
    password = LOCASE_CHARACTERS[random.randrange(len(LOCASE_CHARACTERS)) ] + temp_pass + UPCASE_CHARACTERS[random.randrange(len(UPCASE_CHARACTERS)) ]
